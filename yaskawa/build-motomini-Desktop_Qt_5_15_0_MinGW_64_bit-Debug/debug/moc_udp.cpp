...
QT_MOC_LITERAL(1, 4, 17), // "dataRecieveSignal"
QT_MOC_LITERAL(2, 22, 0), // ""
QT_MOC_LITERAL(3, 23, 9) // "readyRead"

    },
    "UDP\0dataRecieveSignal\0\0readyRead"
};
...
void UDP::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->dataRecieveSignal(); break;
        ...
        {
            using _t = void (UDP::*)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&UDP::dataRecieveSignal)) {
                *result = 0;
                return;
            }
        }
